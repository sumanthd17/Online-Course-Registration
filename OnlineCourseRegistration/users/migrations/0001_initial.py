    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'ADMIN'), ('student', 'STUDENT'), ('faculty', 'FACULTY')], db_column='role', max_length=45)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_Id', models.ForeignKey(db_column='Student_Id', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Student',
                'managed': True,
